...
namespace IdealoFeed\Controller;
...
use IdealoFeed\Grid\DefinitionFactory\CategoryBlacklistGridDefinitionFactory as GridDefinitionFactory;
use IdealoFeed\Grid\Filters\CategoryBlacklistFilters as Filters;
use IdealoFeed\Form\Type\CategoryBlacklistType as Type;
...
class CategoryBlacklistController extends PrestaShopAdminController
{
    ...
    public const INDEX_ROUTE = 'idealofeed_category_blacklist_index';
    public const CREATE_ROUTE = 'idealofeed_category_blacklist_create';
    public const DELETE_ROUTE = 'idealofeed_category_blacklist_delete';
