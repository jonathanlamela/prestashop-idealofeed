...
use IdealoFeed\Grid\DefinitionFactory\ProductBlacklistGridDefinitionFactory as GridDefinitionFactory;
use IdealoFeed\Grid\Filters\ProductBlacklistFilters as Filters;
use IdealoFeed\Form\Type\ProductBlacklistType as Type;
...
class ProductBlacklistController extends PrestaShopAdminController
{
    ...
    public const INDEX_ROUTE = 'idealofeed_product_blacklist_index';
    public const CREATE_ROUTE = 'idealofeed_product_blacklist_create';
    public const DELETE_ROUTE = 'idealofeed_product_blacklist_delete';
